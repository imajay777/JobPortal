...
<body>
	...
	<div id="content">
	<div class="search">
	<h1 style="text-align:center;color:gray">E-mail already exist.<br><br>
	   										 Please try again with another E-mail.<br><br>
	<a href="registration.jsp">Click here</a> for Registration.</h1>
	</div>
		<div id="blocks">									
			<div class="block">
