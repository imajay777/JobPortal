...
<body>
	...
	<div id="content">
		...
		<div id="container">
				<div id="wrapper">
				<div id="bgform">
				<h1><b><i>Welcome to JOB Portal World</i></b></h1>
				</div>
				</div>
				</div>
			</div>		
		...
		<div id="info">
			...
			<div>
				...
				<ul>
					<li>Any good marketer understands the value of market research.</li>
					<li>Practice Until It Feels Natural.</li>
					<li>Job seekers should present their attributes articulately, in a way that makes the most powerful statement.</li>
				</ul>
			</div>
			<div>
