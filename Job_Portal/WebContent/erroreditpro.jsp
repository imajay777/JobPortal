...
%>
	...
	<div id="content">
		...
		<div id="container">
				...
				<form>
					<center>
				<h1><strong>Welcome, <%= session.getAttribute("firstname")%></strong></h1>
				<h2 style="color: rgb(64, 92, 96)">Your Profile is already Created.<br><br>
					You can View or Update Your Profile.</h2>
				<h1></h1>
				<table>
				<tr>
				<td><a href="viewprofile.jsp"><input type="button" value=" View Profile "/></a></td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td><a href="updateprofile.jsp"><input type="button" value=" Update Profile "/></a></td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td><a href="userhome.jsp"><input type="button" value="  Back  "/></a></td>
				</tr>
				</table>	
				</center>
			</form>
