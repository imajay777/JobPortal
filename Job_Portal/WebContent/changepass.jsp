...
function matchpass(){
var firstpassword=document.cpform.newpassword.value;
var secondpassword=document.cpform.cnewpassword.value;
...
return false;
			...
			<form name="cpform" method="post" action="changep.jsp" onsubmit="return matchpass()">
				<%
				String s1 = request.getParameter("email");
				%>				
				<center>
				<h1><strong>Please Enter Your New Password</strong></h1>
				<table>
				<tr>
				<td><b><u>Login E-mail :</u></b></td></tr>
				<tr>
				<td>E-mail</td>
				<td> : <input type="text" name="email" value="<%= s1 %>" readonly/></td></tr>
				<tr><td></td></tr>
				<tr>
				<td><b><u>Change Password :</u></b></td></tr>
				<tr><td>New Password </td>
				<td> : <input type="password" name="newpassword" /></td></tr>
				<tr><td></td></tr>
				<tr><td>Re-Entered New Password </td>
				<td> : <input type="password" name="cnewpassword" /></td></tr>
				</table>
