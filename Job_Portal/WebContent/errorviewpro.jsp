...
%>	
	...
	<div id="content">
		...
		<div id="container">
				...
				<h2 style="color: rgb(64, 92, 96)">Your Profile is not Created.<br><br>
					Please Create Profile.</h2>
				<h1></h1>
				<table>
				<tr>
				<td><a href="editprofile.jsp"><input type="button" value=" Create Profile "/></a></td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td><a href="userhome.jsp"><input type="button" value="   OK   "/></a></td>
				</tr>
				</table>	
				</center>
			</form>
