...
<body>
	...
	<div id="content">
	<div class="search">
	<h1 style="text-align:center;color:gray">Sorry...!!! Email-ID does not match...!!! You Entered Wrong Email or Security Question and Answer.<br>
	Click Here <a href="forgotpass.jsp">Try again</a></h1>
	</div>
		<div id="blocks">									
			<div class="block">
